...
public class DiscoveryDao extends BaseDao {
    ...
    public List<Discovery> findAll(){
        final String query="SELECT id,title,url,description,date_added,category_id, user_id FROM discovery";
    ...
    public List<Discovery> findByCategory(int categoryId){
        final String query = "SELECT id,title,url,description,date_added,category_id, user_id FROM discovery WHERE category_id = ?";
        try (Connection connection = getConnection();
    ...
    public void save(Discovery discovery){
        final String query = "INSERT INTO discovery(title,url,description,date_added,category_id,user_id) VALUES (?,?,?,?,?,?)";
        try(Connection connection = getConnection();
